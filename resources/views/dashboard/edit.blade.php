...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/user-profile/edit/{{ $user->id }}" method="post" class="mb-5" enctype="multipart/form-data">
            @csrf
            @method('put')
            ...
            <div class="mb-3">
                ...
                is-invalid
            @enderror"
                    id="name" name="name" required value="{{ old('name', $user->name) }}" autofocus disabled>
            ...
            <div class="mb-3">
                ...
                <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                    <input type="checkbox" class="btn-check" id="isAdmin" autocomplete="off" value="1"
                        name="is_admin" {{$user->is_admin ? 'checked' : ''}} disabled>
                    <label class="btn btn-outline-primary" for="isAdmin">is Admin</label>

                    <input type="checkbox" class="btn-check" id="isITSupport" autocomplete="off" value="1"
                        name="is_itsupports" {{$user->is_itsupports ? 'checked' : ''}} disabled>
                    <label class="btn btn-outline-primary" for="isITSupport">is IT Support</label>

                    <input type="checkbox" class="btn-check" id="isBanned" autocomplete="off" value="1"
                        name="is_banned" {{$user->is_banned ? 'checked' : ''}} disabled>
            ...
            <div class="mb-3">
                ...
                is-invalid
            @enderror"
                    id="email" name="email" required value="{{ old('email', $user->email) }}" autofocus disabled>
            ...
            <input class="btn btn-primary" type="submit" value="Edit Password Now">
        </form>
    </div>
