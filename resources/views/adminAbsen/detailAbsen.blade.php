...
@section('container')
    ...
    <div class="col-lg-8">
        <form action="/user-account/edit/absen/{{ $attendance->id }}" method="post" class="mb-5"
            ...
            <div class="mb-3">
                ...
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                    ...
                    <input type="radio" class="btn-check" name="absen" id="btnradio3" autocomplete="off"
                        value="permission" {{ $attendance->permission ? 'checked' : '' }}>
                    ...
                    <input type="radio" class="btn-check" name="absen" id="btnradio4" autocomplete="off"
                        value="Not Absent" {{ $attendance->notAbsent ? 'checked' : '' }}>
                    <label class="btn btn-outline-danger" for="btnradio4">Not Absent</label>
                </div>
            </div>
