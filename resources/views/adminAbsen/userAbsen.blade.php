...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">You have accessed {{ $user->name }}'s account</h1>
    </div>
    <div class="pb-2">
        <a href="/user-account/download/{{ $user->id }}" class="text-success">
            ...
            <div class="card h-100">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <br>
                    <a href="/user-account/detail/absen/{{$attendance->id}}" class="btn btn-primary">Detail</a>
                </div>
            </div>
        </div>
        @endforeach
